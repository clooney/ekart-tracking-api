Ekart Tracking API - .Net
================================
Use .Net to track Ekart shipments with Ekart Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.courierCode = "ekart";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "MYEC1029775310,MYSC1114644676";
                  getTrackingResultsParams.courierCode = "ekart";
